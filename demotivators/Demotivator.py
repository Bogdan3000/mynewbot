...
class Demotivator:
    ...
    def create(self, file: str, watermark=None, result_filename='demresult.jpg',
               ...
               font_name='"minecraft.ttf', top_size=80, bottom_size=60,
        ...
        """
        font_1 = ImageFont.truetype(font='minecraft.ttf', size=top_size, encoding='UTF-8')
        ...
        font_2 = ImageFont.truetype(font='minecraft.ttf', size=bottom_size, encoding='UTF-8')
        ...
        if watermark is not None:
            ...
            font_2 = ImageFont.truetype(font='minecraft.ttf', size=20, encoding='UTF-8')

...
class Demotivator:
    ...
    def create(self, file: str, watermark=None, result_filename='demresult.jpg',
               ...
               font_name='courier-new-cyr_[allfont.ru].ttf', top_size=80, bottom_size=60,
        ...
        """
        font_1 = ImageFont.truetype(font='courier-new-cyr_[allfont.ru].ttf', size=top_size, encoding='UTF-8')
        ...
        font_2 = ImageFont.truetype(font='courier-new-cyr_[allfont.ru].ttf', size=bottom_size, encoding='UTF-8')
        ...
        if arrange:
            drawer.multiline_text((((width + 250) - size_1[0]) / 2, ((height + 190) - size_1[1])),
                        self._top_text, fill=font_color,
                        font=font_1)
            drawer.multiline_text((((width + 250) - size_2[0]) / 2, ((height + 235) - size_2[1])),
                        self._bottom_text, fill=font_color,
                        font=font_2)
        else:
            drawer.multiline_text(((1280 - size_1[0]) / 2, 840), self._top_text, fill=font_color, font=font_1)
            drawer.multiline_text(((1280 - size_2[0]) / 2, 930), self._bottom_text, fill=font_color, font=font_2)
        ...
        if watermark is not None:
            ...
            font_2 = ImageFont.truetype(font='courier-new-cyr_[allfont.ru].ttf', size=20, encoding='UTF-8')
            size_2 = idraw.textsize(watermark.lower(), font=font_2)
            idraw.multiline_text((((width + 729) - size_2[0]) / 2, ((height - 192) - size_2[1])),
